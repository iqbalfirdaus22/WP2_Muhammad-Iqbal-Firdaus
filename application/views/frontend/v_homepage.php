    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <h1 class="intro-title mb-4">Muhammad Iqbal Firdaus</h1>
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    ...
                    <div class="w-more">
                      <span class="w-ctegory">Web Design</span> / <span class="w-date">18 Maret 2020</span>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="w-like">
      ...
      <div class="row">
        <div class="col-md-12">
          <div id="testimonial-mf" class="owl-carousel owl-theme">
            ...
            <div class="testimonial-box">
              <div class="author-test">
                <img src="https://i.imgur.com/uBBIp38.jpg" alt="" class="rounded-circle b-shadow-a">
                <span class="author">Poliban</span>
              </div>
              <div class="content-test">
                <p class="description lead">
                  Website yang menarik, dibangun menggunakan CodeIgniter, menggunakan template AdminLTE pada sisi Back-End, menggunakan template DevFolio pada sisi Front-End.
